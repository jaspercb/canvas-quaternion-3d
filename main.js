...
Sphere.prototype.preDraw = function(camera, screenwidth, screenheight) {
    ...
    if (this.shouldDraw) { //why waste time if we ain't gonna draw this
        ...
        temp = this.projectedPos.getScreenPos(camera, screenwidth,
            screenheight);
        this.drawX = temp[0];
        this.drawY = temp[1];
    }
...
Line.prototype.preDraw = function(camera, screenwidth, screenheight) {
    ...
    if (this.shouldDraw) { //why waste time if we ain't gonna draw this
        ...
        temp = this.projectedPos1.getScreenPos(camera, screenwidth,
            screenheight);
        this.draw1X = temp[0];
        this.draw1Y = temp[1];
...
var mouseMoveListener = function(e) {
    if (mouseDown) {
        ...
        if (e.shiftKey) {
            tmp = new Quaternion(0, -0.001 * dMouseX * cameraDistance, -0.001 *
